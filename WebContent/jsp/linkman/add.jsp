...
<BODY>
	...
	<FORM id=form1 name=form1
	action="${pageContext.request.contextPath }/addLinkMan" method=post>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5 border=0>
							<tr>
								...
								</select> <!-- 	<input type="text" name="cust_name"
							...
							<TR>
								<td>联系人名称：</td>
								<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px" required
									maxLength=50 name="linkman.lkm_name"></td>
								<td>联系人性别：</td>
								<td><input type="radio" value="1" name="linkman.lkm_gender">男
							...
							<TR>
								...
								<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
									maxLength=50 name="linkman.lkm_phone"></td>
								<td>联系人手机 ：</td>
								<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
									maxLength=50 name="linkman.lkm_mobile"></td>
						</TR>
							<tr>
