									...
									<TD height=25>
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>联系人名称：</TD>
													<TD><INPUT class=textbox id=sChannel2 name="lkm_name"
									...
									<TD>
										...
										cellSpacing=1 cellPadding=2 rules=all border=0>
											<TBODY>
												...
												<c:forEach items="${pageBean.list_linkman }" var="linkman">
													<TR
														...
														<TD><a
															href="${pageContext.request.contextPath }/updateLinkMan?linkman.lkm_id=${linkman.lkm_id}">修改</a>
															&nbsp;&nbsp; <a
															href="${pageContext.request.contextPath }/deleteLinkMan?linkman.lkm_id=${linkman.lkm_id}">删除</a>
													</TD>
														<%-- <TD>
